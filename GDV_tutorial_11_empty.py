...
dst_anisotropic_scaling = cv2.warpAffine(img, T_anisotropic_scaling, (cols, rows))

# TODO: define rotation matrix for 45° clockwise rotation

phi_rad = (45 / 180.0) * np.pi
...
T_rotation_around_center = cv2.getRotationMatrix2D(center=(200,200), angle=45, scale=1)
